...
export const metadata: Metadata = {
  ...
  description:
    "Learn more about Webarify — a Morocco-based web and branding agency with a global reach. Découvrez Webarify — une agence web et de branding basée au Maroc avec une portée internationale.",
  keywords: [
    // English
    "about Webarify",
      ...
      <main className="container mx-auto px-4 py-16 relative">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="grid md:grid-cols-3 lg:max-w-[1200px] gap-8 mb-20 justify-end">
            <div>
              <span className="text-[#278783] text-sm">
